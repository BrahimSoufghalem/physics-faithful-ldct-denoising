...
\begin{enumerate}
  ...
  \item \textbf{No reader study or task-based assessment} --- physics metrics are reproducible surrogates, not observer performance.
