"""WGAN-VGG -- copied from ldctbench/methods/wganvgg/network.py
...
class WGANVGGGenerator(nn.Module):
    """Generator for WGAN-VGG (Yang et al. 2018).

    Copied exactly from ldctbench/methods/wganvgg/network.py (class Model).
    8 conv layers, 32 channels, direct output (no residual connection).
    """
