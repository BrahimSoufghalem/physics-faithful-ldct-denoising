"""DU-GAN -- copied from ldctbench/methods/dugan/network.py
(github.com/eeulig/ldct-benchmark, commit 09b1011bc2fb77ef4fc734cec1e961a20c754910).

IMPORTANT: in the ldct-benchmark implementation the DU-GAN GENERATOR is
exactly the RED-CNN network (dugan/network.py does
`from ldctbench.methods.redcnn.network import Model`). The method's novelty
...
class DUGANGenerator(RedCNN):
    """DU-GAN generator = RED-CNN (see module docstring)."""
